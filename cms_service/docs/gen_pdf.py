...
with codecs.open('AI_CHEMICAL_MODIFICATION_FORMULAS_UPDATED.md', 'w', 'utf-8-sig') as f:
    f.write(md_content)

try:
    pdf = MarkdownPdf(toc_level=0)
    pdf.add_section(Section(md_content))
    pdf.save('AI_CHEMICAL_MODIFICATION_FORMULAS_UPDATED.pdf')
    print('Updated document and PDF successfully generated!')
